...
_G.packer_plugins = {
  ...
  ["prettier.nvim"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/prettier.nvim",
  ...
  ["vim-commentary"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/vim-commentary",
  ...
  ["vim-visual-multi"] = {
    loaded = true,
    path = "/Users/lucas/.local/share/nvim/site/pack/packer/start/vim-visual-multi",
