...
_G.packer_plugins = {
  ...
  ["mini.pairs"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/mini.pairs",
  ...
  ["prettier.nvim"] = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/prettier.nvim",
  ...
  vimux = {
    loaded = true,
    path = "/home/lucas/.local/share/nvim/site/pack/packer/start/vimux",
